...
let User = {
    ...
    About: "Hey, I am a New York-based, Web and Software Developer, with a passion for thinking out of the box.<br />I started as a Microsoft Web Technologies developer in 2008 amazed by the new wave of server client websites. Recently I joined Thinkful to learn and reinvent my technology stack and today I am a versatile and prolific developer. I have developed and worked with a range of organizations from startups to well esablished businesses around the globe.<br/> This love for technology and severs didn't end there. I have a good hardware knowledge and know how to interface between technologies to make practically anything I set my mind to interconnected. From switches and lightbulbs, home entertainment, to drones and security cameras. My goal is to create a world that can integrate seamlesly with a users day to day schedule, while keeping them in a secure clean enviroment.<br/> Thinking Big Enough? ;)", 
    SocialMedia: {
